...
> 关联 [../AI测试工具调研.md](../AI测试工具调研.md) · 用于讲解要点准备
>
> 用法：每题分「问题 → 60 秒话术 → 深挖点 → 我在 FEDrill 哪里用了」。深挖点是教练二问的方向，提前想好；FEDrill 引用是把回答落到项目上，比空谈框架加分。
...
1. **每题准备一个 FEDrill 例子**。教练问原理，你答完总能补一句「我在 FEDrill 的 XX 里就这么做的，效果是……」。
