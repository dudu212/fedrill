...
> 版本 v2.0 · 2026-09-05
>
> 定位：**复习入口文档**。按"层 × 数据流 × Agent 设计"三视角组织，覆盖 M1 → M2a Phase 1a → 沙箱红队 Step 5 → BYOK 全部现状。
>
...
**这是 M2a 项目最亮的一条流量**。9 个 actor，14 步端到端。
